@extends('layouts.app')
@section('title', 'Keterangan Rujuk Cerai')
@section('content')
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Buat Surat Keterangan Rujuk Cerai</h4>
        <p class="card-description">
          Isi form dibawah ini
        </p>
        <form class="forms-sample" method="POST" action="{{ route('cerai.store') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            <label for="name">Nama Pasangan Ayah</label>
          ...
          <div class="form-group">
            <input type="text" class="form-control" value="cerai" name="type" hidden>
          </div>
