@extends('layouts.app')
@section('title', 'Keterangan Rujuk')
@section('content')
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{ url('/keterangan/rujuk/'.$item->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            <input type="text" class="form-control" value="rujuk" name="type" hidden>
          </div>
          @role('admin')
          <div class="form-group">
