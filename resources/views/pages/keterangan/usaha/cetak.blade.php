<style type="text/css">
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT KETERANGAN USAHA </h3>
        </td>
      </tr>
      <tr>
        <td align="center">
      ...
      <table>
        <table width='100%' align="left">
          ...
          <tr>
            <td></td>
            <td>Berlaku Mulai</td>
            <td>: {{ $item->valid_from }} Sampai dengan {{ $item->valid_until }}</td>
          </tr>
        </table>
        
        <p>Orang tersebut di atas adalah benar-benar warga Desa {{ $kantor->village }} yang memiliki usaha {{ $item->domisili_usaha_lokal->name }}</p>
