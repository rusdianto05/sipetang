<style type="text/css">
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT KETERANGAN DOMISILI USAHA NON WARGA</h3>
        </td>
      </tr>
      <tr>
        <td align="center">
    ...
    <table width='100%'>
      ...
      <table>
        <table width='100%' align="left">
          ...
          <tr>
            <td></td>
            <td>Nomor Akta/Tahun/Notaris</td>
        ...
        <p>Demikian surat ini dibuat, untuk dipergunakan sebagaimana mestinya
        <br><br>
        <table width=100%>
          <tr>
            <td width="30%">
