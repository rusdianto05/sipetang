<style type="text/css">
  ...
  <title>Print Data Surat Keterangan Wali</title>
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT KETERANGAN WALI </h3>
        </td>
      </tr>
      <tr>
        <td align="center">
  ...
  <br><br>
    <table width='100%'>
      ...
      <table>
        ...
        <p>Yang namanya tersebut di atas memang benar warga kami yang akan menikah di KUA {{ strtoupper($item->sub_district) }} {{ strtoupper($item->regency) }}
            . Berhubung orang tersebut tidak memiliki Wali Nasab, kami mohon dengan hormat Bapak
             Kepala KUA {{ strtoupper($item->sub_district) }} supaya berkenan menjadi Wali.
        <br><br>
