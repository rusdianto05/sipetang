<style type="text/css">
  ...
  <title>Print Data Surat Permohonan Duplikat Surat Nikah</title>
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT PERMOHONAN DUPLIKAT SURAT NIKAH </h3>
        </td>
      </tr>
      <tr>
        <td align="center">
  ...
  <br><br>
    <table width='100%'>
      ...
      <table>
        ...
        <p>Yang namanya tersebut di atas memang benar warga kami dan telah menikah di KUA {{ $kantor->sub_district }} 
            pada {{ $item->tgl_nikah}} dengan seseorang yang bernama {{ $item->nama_pasangan }}. Berdasarkan data di atas 
            mohon untuk dibuatkan Duplikat Surat Nikah orang tersebut di atas.</p>
       <p>Demikian surat permohonan duplikat surat nikah ini dibuat dengan sebenarnya, untuk dipergunakan sebagaimana mestinya.</p>
        <table width=100%>
          <tr>
            <td width="30%">
            </td>
