...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Buat Surat Permohonan Kartu Keluarga</h4>
        <p class="card-description">
          Isi form dibawah ini
        </p>
        <form class="forms-sample" method="POST" action="{{ route('kk.store') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="type" name="type">
              ...
              <option value="rubah">Rubah KK</option>
            </select>
          </div>
