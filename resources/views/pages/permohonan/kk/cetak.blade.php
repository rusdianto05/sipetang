<style type="text/css">
  ...
  <title>Print Data Surat Permohonan Kartu Keluarga</title>
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT PERMOHONAN KARTU KELUARGA </h3>
        </td>
      </tr>
      <tr>
        <td align="center">
          ...
          <tr>
            ...
            <td width="30%">
              ...
              <table align="center">
                ...
                <tr><td>Mengetahui, <br> Camat {{ $kantor->sub_district }}<br><br><br><br> <u>{{ $kantor->camat }}</u><br>
  
                  NIP. {{ $kantor->camat_id }}</td></tr>
