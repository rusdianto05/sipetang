<style type="text/css">
  ...
  <title>Print Data Surat Perijinan Keramaian</title>
  ...
  <body onLoad="window.print()">
    ...
    <table width=100%>
      <tr>
        <td align="center">
          <h3 style='margin-bottom:-5px' align=center>SURAT PERIJINAN KERAMAIAN </h3>
        </td>
      </tr>
      <tr>
        <td align="center">
  ...
  <br><br>
    <table width='100%'>
      ...
      <table>
        ...
        <p>Orang tersebut adalah benar-benar warga Desa {{ $kantor->village }} dengan data seperti di atas.</p>
